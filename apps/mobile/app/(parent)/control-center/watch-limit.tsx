...
export default function WatchLimitScreen() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      setDailyLimitMinutes(data?.dailyLimitMinutes ?? 120);
      setBedtimeStart(data?.bedtimeStart ?? '21:00');
      setBedtimeEnd(data?.bedtimeEnd ?? '07:00');
    } catch {
  ...
  async function handleSave() {
    ...
    if (!timeRegex.test(bedtimeStart) || !timeRegex.test(bedtimeEnd)) {
      Alert.alert('Invalid time', 'Please enter times in HH:MM format (e.g. 21:00).');
      return;
    }
    ...
    try {
      ...
      Alert.alert('Saved', 'Watch Limit settings updated successfully.');
    } catch {
      ...
      <SafeAreaView style={styles.safeArea} edges={['top']}>
        ...
        <Animated.View entering={FadeInDown.delay(50).springify()} style={styles.header}>
          ...
          <View style={styles.headerCenter}>
            <Text style={styles.headerTitle}>Watch Limit</Text>
        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
          ...
          <Animated.View entering={FadeInDown.delay(100).springify()}>
            <Text style={styles.sectionLabel}>DAILY SCREEN TIME LIMIT</Text>
          </Animated.View>
          ...
          <Animated.View entering={FadeInDown.delay(140).springify()} style={styles.card}>
            <View style={styles.cardRow}>
              ...
              <View style={styles.cardInfo}>
                ...
                <Text style={styles.cardDesc}>Maximum screen time per day</Text>
              </View>
            </View>
            <Stepper
            ...
            <Text style={styles.limitCaption}>
              {dailyLimitMinutes === 0 ? 'No limit set' : `${formatMinutes(dailyLimitMinutes)} per day`}
            </Text>
          </Animated.View>

          {/* Bedtime Mode */}
          <Animated.View entering={FadeInDown.delay(200).springify()}>
            <Text style={styles.sectionLabel}>BEDTIME MODE</Text>
          </Animated.View>

          <Animated.View entering={FadeInDown.delay(240).springify()} style={styles.card}>
            <Text style={styles.bedtimeInfo}>
              🌙 During bedtime, the app will be locked.
            </Text>
            ...
            <View style={styles.timeRow}>
              ...
              <View style={styles.timeField}>
                <Text style={styles.timeLabel}>🌅 Bedtime End</Text>
                <TextInput
                  style={styles.timeInput}
                  value={bedtimeEnd}
          ...
          <Animated.View entering={FadeInDown.delay(300).springify()} style={styles.card}>
            <View style={styles.toggleRow}>
              <View style={styles.toggleInfo}>
                <Text style={styles.toggleTitle}>Apply to All Children</Text>
                <Text style={styles.toggleDesc}>Use these limits for all kids in the family</Text>
              </View>
              <Switch
                value={applyToAll}
