    ...
    <section className="relative overflow-x-clip bg-bg-base px-4 py-20">
      ...
      <div className="relative z-10 mx-auto max-w-5xl">
        ...
        <div className="relative mt-12">
          ...
          <div className="pointer-events-none relative z-[3] mx-auto mb-6 flex w-[min(8.5rem,48vw)] max-w-full shrink-0 justify-center md:absolute md:mb-0 md:left-0 md:top-[38%] md:w-[min(12.5rem,34vw)] md:max-w-[13.5rem] md:-translate-x-[min(7.5rem,20vw)] md:-translate-y-1/2 lg:top-[36%] lg:w-[min(13.5rem,32vw)] lg:-translate-x-[min(9rem,22vw)]">
            <ProblemKidMascot
