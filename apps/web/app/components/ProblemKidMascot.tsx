  ...
  return (
    <div className={`relative ${className}`}>
      ...
      <AnimatePresence>
        <motion.div
            aria-hidden
            className="absolute bottom-[91%] left-[5%] z-10 w-[min(16rem,calc(100vw-2.2rem))] sm:bottom-[94%] sm:left-[2%]"
            initial={
              reduceMotion
      ...
      <motion.div
        className="relative mx-auto w-full max-w-[12.5rem] drop-shadow-[0_18px_40px_rgba(15,23,42,0.16)] sm:max-w-[13.5rem]"
      ...
      >
        ...
        >
          <svg viewBox="0 0 200 260" className="h-auto w-full" role="img">
            ...
            {/* Head */}
            <ellipse cx="100" cy="86" rx="46" ry="50" fill="#FFE4D4" stroke="#E8B4A0" strokeWidth="1.4" />
            ...
            <path d="M76 68 Q84 62 92 66" fill="none" stroke="#4A3728" strokeWidth="2.8" strokeLinecap="round" />
            <path d="M108 66 Q116 62 124 68" fill="none" stroke="#4A3728" strokeWidth="2.8" strokeLinecap="round" />
